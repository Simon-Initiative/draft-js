...
var DraftEditorContents = function (_React$Component) {
  ...
  DraftEditorContents.prototype.render = function render() {
    var _props = this.props,
        renderPostProcess = _props.renderPostProcess,
    ...
    for (var _ii = 0; _ii < processedBlocks.length;) {
      ...
      if (info.wrapperTemplate) {
        ...
        var originals = [];
        do {
          _blocks.push(processedBlocks[_ii].block);
          originals.push(processedBlocks[_ii].original);
          _ii++;
        ...
        originalBlocks.push(info.original);
        _ii++;
      }
    }
    ...
    return React.createElement(
      'div',
      { 'data-contents': 'true' },
      this.props.renderPostProcess(outputBlocks)
    );
  };
